...
import { APPOINTMENT_ATTENDANCE, dateUTCtoLocal } from "lib";
...
export const AppointmentsTableAdmin: React.ForwardRefRenderFunction<
  HTMLInputElement,
...
> = ({ appointments, disabled }) => {
  ...
  return (
    <div className="flex flex-col w-full py-4 gap-3 text-sm">
      <div className="grid grid-cols-6 py-2 bg-principal-50 text-center rounded-lg font-bold">
        <div>Cédula</div>
...
const AppointmentsRow: React.FC<rowProps> = ({
  ...
  return (
    <div className="grid grid-cols-6 items-center py-2 bg-principal-150 rounded-lg text-center border border-principal-50">
