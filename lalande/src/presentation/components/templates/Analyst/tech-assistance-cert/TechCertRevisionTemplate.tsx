...
export const TechCertRevisionTemplate = () => {
  ...
  const SearchUrlParams = () => {
    ...
    const appointment = searchParams.get("id");
  ...
  const handleFormClick = async (status: TECH_REVISION_STATUS) => {
    const APPROVE_MSG =
      "¿Estas seguro que deseas ENVIAR la información APROBAR este registro?";
    const REJECT_MSG =
  ...
  const onSubmit = async (information: SaveAssistanceStatusForm) => {};
  ...
  return (
    <div className="w_full md:w-11/12 xl:w-2/3">
      ...
      <div className="py-5">
        ...
        <SecondaryText
          text={"Selecciona el estado para el certificado actual"}
        />
        <SectionSeparator />
