...
import { MultilineTextDateInputList } from "domain/models/tech-assistance-cert/techAssistanceForm";
import { TextDateMolecule, TextDateMoleculeList } from "lib";
import Image from "next/image";
import { CustomInputOne, DatePickerGrayInput } from "presentation";
import {
  ChangeEvent,
  CSSProperties,
  FormEvent,
      ...
      >
        {!readOnly ? (
          <div className="flex justify-end">
            <div>
              <Image
                src={"/lalande/icons/plus_icon.png"}
                alt="+"
                width={20}
                height={20}
                draggable={false}
