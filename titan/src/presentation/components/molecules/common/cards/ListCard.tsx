...
export const ListCard = ({
  ...
  return (
    <div className="w-[16rem] h-[5rem] rounded-xl menuCardShadow relative bg-[#FFF] flex flex-row items-center cursor-pointer hover:scale-[102%] active:scale-100 z-10">
      {betaAccess && (
      ...
      {loading ? (
        ...
        <>
          ...
          <NeutralNCText
            text={label}
            className="w-full pr-8 text-start flex font-normal items-start justify-start flex-1 md:w-1/2 md:pr-8 text-md cf-text-principal-180"
          />
