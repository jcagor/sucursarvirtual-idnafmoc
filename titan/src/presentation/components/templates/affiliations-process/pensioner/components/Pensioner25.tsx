...
const Pensioner25 = () => {
  ...
  const handleSelectEntity = () => {
    if (isLoading) return;
    setIsLoading(true);
    saveFlowUrl(AFFILIATIONS_PENSIONER_FLOW_URL("pensioner-25"), "pensioner-25");
    router.push("/menu-affiliations/pensioner/pensioner-25/complete-information");
  };
      ...
      <Card className="flex flex-col justify-between items-center h-[600px] max-w-96 py-6">
        <div className="flex flex-col items-center w-full flex-1">
          <div className="flex items-center justify-center h-[160px] w-full">
            <Image
              src="/icons/render-3d-personaje-avatar.svg"
              alt="pensionado-con-25-años-de-trabajo"
              width={160}
              height={160}
            />
          </div>
          <div className="w-full mt-6">
            <h4 className="text-principal-180 font-semibold text-center leading-tight min-h-[48px] max-h-[56px] flex items-center justify-center">
              Pensionado con 25 años de trabajo acreditado al Sistema de Cajas de Compensación
            </h4>
          </div>
          <div className="w-full mt-6">
            <p className="px-8 text-center min-h-[60px] max-h-[160px] overflow-hidden flex items-center justify-center">
              Afíliate sin pago de aportes y accede a programas de capacitación, recreación y turismo social a las tarifas más bajas.
            </p>
          </div>
        </div>
        <div className="flex flex-col items-center w-full gap-2 mt-4">
          ...
          />
          <button
            className="text-principal-180 text-sm font-semibold underline mt-4"
          ...
          <div className="w-full flex flex-col gap-4">
            ...
            <div className="w-full flex items-center gap-2">
              ...
              <h3 className="text-principal-180 text-lg font-normal max-w-[500px]">
                Adjunta la fotocopia del último recibo de mesada con el valor de
                pensión sin deducciones.
              </h3>
            </div>
            <div className="w-full flex items-center gap-2">
              <div className="w-10 h-10 bg-principal-180 rounded-full flex items-center justify-center">
              ...
              <h3 className="text-principal-180 text-lg font-normal max-w-[500px]">
                Adjunta la fotocopia el certificado del tiempo de afiliación de
                las cajas a las cuales perteneció
              </h3>
            </div>
          </div>
