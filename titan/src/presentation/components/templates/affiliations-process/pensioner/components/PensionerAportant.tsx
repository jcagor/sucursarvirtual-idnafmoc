...
const PensionerAportant = () => {
  ...
  const handleSelectEntity = () => {
    ...
    setIsLoading(true);
    saveFlowUrl(
      AFFILIATIONS_PENSIONER_FLOW_URL("aportant"),
      "pensioner-aportant"
    );
    router.push("/menu-affiliations/pensioner/pensioner-aportant/select-entity");
  };
      ...
      <Card className="flex flex-col justify-between items-center h-[600px] max-w-96 py-6">
        <div className="flex flex-col items-center w-full flex-1">
          <div className="flex items-center justify-center h-[160px] w-full">
            <Image
              src="/icons/3d-ilustracion-persona-gafas.svg"
              alt="pensionado-aportante"
              width={160}
              height={160}
            />
          </div>
          <div className="w-full mt-6">
            <h3 className="text-principal-180 font-semibold text-center leading-tight min-h-[48px] max-h-[56px] flex items-center justify-center">
              Pensionado aportante
            </h3>
          </div>
          <div className="w-full mt-6">
            <p className="px-8 text-center min-h-[60px] max-h-[160px] overflow-hidden flex items-center justify-center">
              Con un aporte del 0,6 o 2,0% de tu mesada pensional tendrás acceso
              a recreación, deporte, cultura y turismo, subsidio de vivienda y
              educación.
            </p>
          </div>
        </div>
...
export default PensionerAportant;
