...
@injectable()
export default class ListPendingPsyTestUseCase {
  ...
  async execute(): Promise<PsyTestPendingList | undefined> {
    return await this.userRannRepository.listPendingPsyTestExam();
  }
}
