    ...
    >
      <div className={`w-full h-full`}>
        ...
        <select
          className={
            selectClassName ??
            `w-full h-[calc(48px)] outline-principal-180 px-4 py-3 ${readOnly ? "bg-principal-460" : "bg-principal-150"} text-principal-450 placeholder-principal-460 has-[option.placeholder:checked]:text-principal-460 border-[calc(1px)] rounded-[calc(5px)] font-outfit text-[calc(15px)]`
          }
          disabled={readOnly}
          style={selectStyle}
          onChange={onChange}
...
interface CustomSelectGrayProps
    ...
    >
      <div className={`w-full h-full`}>
        ...
        <select
          className={
            selectClassName ??
            `w-full h-[calc(48px)] border-principal-400 px-4 py-3 ${readOnly ? "bg-principal-460" : "bg-principal-150"} text-principal-450 placeholder-principal-460 has-[option.placeholder:checked]:text-principal-460 border-[calc(2px)] rounded-[calc(5px)] font-outfit text-[calc(15px)]`
          }
          disabled={readOnly}
          style={selectStyle}
          onChange={onChange}
        ...
        >
          <option
            className={`text-principal-460 placeholder-principal-460 placeholder`}
            disabled
            value={""}
          >
            Selecciona {label}
