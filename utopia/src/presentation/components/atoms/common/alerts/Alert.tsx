...
import { removeAlert } from "presentation/store/slices/alertSlice";
...
const SuccessAlert = ({ alert, onClose, closingAlerts }: AlertProps) => (
  <AlertTemplate
    ...
    closingAlerts={closingAlerts}
    bgColor="bg-[#D6F0E0]"
    iconSrc="/utopia/icons/SuccesAlertIcon.svg"
    iconColor="bg-[#00C393]"
  />
);
...
const ErrorAlert = ({ alert, onClose, closingAlerts }: AlertProps) => (
  <AlertTemplate
    ...
    closingAlerts={closingAlerts}
    bgColor="bg-[#F9E1E5]"
    iconSrc="/utopia/icons/ErrorAlertIcon.svg"
    iconColor="bg-[#EB5757]"
  />
);
...
const WarningAlert = ({ alert, onClose, closingAlerts }: AlertProps) => (
  <AlertTemplate
    ...
    closingAlerts={closingAlerts}
    bgColor="bg-[#FBF0DA]"
    iconSrc="/utopia/icons/WarningAlertIcon.svg"
    iconColor="bg-[#F2C94C]"
  />
);
...
const InfoAlert = ({ alert, onClose, closingAlerts }: AlertProps) => (
  <AlertTemplate
    ...
    closingAlerts={closingAlerts}
    bgColor="bg-[#DEF1F7]"
    iconSrc="/utopia/icons/InfoAlertIcon.svg"
    iconColor="bg-[#5458F7]"
  />
);
